 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qtype_autospeak_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '../../qtype', 'autospeak');
        ...
        $cloudpoodll = new backup_nested_element('cloudpoodll', array('id'), array(
            'questionid','questionstyle','ttslanguage','transcriber'));
