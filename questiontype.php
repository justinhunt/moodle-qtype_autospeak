 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_autospeak extends question_type {
    public function extra_question_fields() {
        return array('qtype_autospeak_options','ttslanguage','transcriber','questionstyle');
    }
    ...
    public function save_question_options($question) {
        ...
        //other options
        $question->ttslanguage = constants::LANG_ENUS;
        $question->transcriber = constants::TRANSCRIBER_POODLL;
        $question->questionstyle=constants::QSTYLE_STANDARD;
