...
/**
 * Unit tests for the autospeak question type class.
 *
...
global $CFG;
require_once($CFG->dirroot . '/question/type/autospeak/questiontype.php');
require_once($CFG->dirroot . '/question/engine/tests/helpers.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/autospeak/edit_autospeak_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_autospeak_test extends advanced_testcase {
    public static $includecoverage = array(
        'question/type/questiontypebase.php',
        'question/type/autospeak/questiontype.php',
    );

    protected $qtype;

    protected function setUp(): void {
        $this->qtype = new qtype_autospeak();
    }
    ...
    protected function get_test_question_data() {
        return test_question_maker::get_question_data('autospeak');
    }

    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'autospeak');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('autospeak');
    ...
    public function test_get_possible_responses_no_star() {
        $q = test_question_maker::get_question_data('autospeak', 'frogonly');
    ...
    public function test_question_saving_frogtoad() {
        ...
        $questiondata = test_question_maker::get_question_data('autospeak');
        $formdata = test_question_maker::get_question_form_data('autospeak');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_autospeak_edit_form::mock_submit((array)$formdata);

        $form = qtype_autospeak_test_helper::get_question_editing_form($cat, $questiondata);
