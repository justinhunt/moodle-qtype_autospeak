...
Feature: Test editing a Short answer question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | autospeak | autospeak-001 for editing | frogtoad |
  ...
  Scenario: Edit a Short answer question
    When I choose "Edit question" action for "autospeak-001" in the question bank
    And I set the following fields to these values:
      | Question name | |
    And I press "id_submitbutton"
    Then I should see "You must supply a value here."
    When I set the following fields to these values:
      | Question name | Edited autospeak-001 name |
    And I press "id_submitbutton"
    Then I should see "Edited autospeak-001 name"
    When I choose "Edit question" action for "Edited autospeak-001" in the question bank
    And I set the following fields to these values:
      | id_answer_1          | newt                       |
      | id_fraction_1        | 70%                        |
    ...
    And I press "id_submitbutton"
    Then I should see "Edited autospeak-001 name"
    When I choose "Preview" action for "Edited autospeak-001" in the question bank
