...
/**
 * Test helpers for the autospeak question type.
 *
 * @package    qtype_autospeak
...
/**
 * Test helper class for the autospeak question type.
 *
 * @copyright  2022 Poodll
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_autospeak_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a autospeak question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_autospeak_question
     */
    public function make_autospeak_question_frogtoad() {
        question_bank::load_question_definition_classes('autospeak');
        $sa = new qtype_autospeak_question();
        ...
        $sa->qtype = question_bank::get_qtype('autospeak');

        return $sa;
    }

    /**
     * Gets the question data for a autospeak question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_autospeak_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'autospeak';
    ...
    /**
     * Gets the question form data for a autospeak question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_autospeak_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a autospeak question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_autospeak_question
     */
    public function make_autospeak_question_frogonly() {
        question_bank::load_question_definition_classes('autospeak');
        $sa = new qtype_autospeak_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a autospeak questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_autospeak_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_autospeak_question
     */
    public function make_autospeak_question_escapedwildcards() {
        question_bank::load_question_definition_classes('autospeak');
        $sa = new qtype_autospeak_question();
        test_question_maker::initialise_a_question($sa);
